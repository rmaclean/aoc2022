...
const main = async () => {
    ...
    const lines = inputDataRaw.toString().split("\n").map(line => {
        ...
        // group 1 inside group 2
        (group.group1Start >= group.group2Start && group.group1End <= group.group2End) ||
        // group 2 inside group 1
        (group.group2Start >= group.group1Start && group.group2End <= group.group1End)
    )
